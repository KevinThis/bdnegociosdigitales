...
El `alumno` creará bases de datos relacionales y no relacionalesa tráves de esquemas de **administración** y *seguridad* para manipular datos almacenados en la nube.
...
![Imagen Base de Datos](./img/images%20(1).jpg "This is a sample image.")

Puedes utilizar [Markdown Live Preview](https://www.google.com/search?udm=2&q=imagen+perrona&aic=0#sv=CAMSVhoyKhBlLVZHWWpnRi0zc09XWnRNMg5WR1lqZ0YtM3NPV1p0TToOYnIyc0dWTkdIN2VQVk0gBCocCgZtb3NhaWMSEGUtVkdZamdGLTNzT1dadE0YADABGAcgquyVhgQwAkoKCAIQAhgCIAIoAg).
...
![This is an alt text.](./img/Gemini_Generated_Image_gfdt42gfdt42gfdt.png "This is a sample image.")